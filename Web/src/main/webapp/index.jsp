                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <c:if test="${(not empty user and user.role.id < 3) or (not empty user and user.id == record.author.id)}">
                            <a href="controller?action=editrecord&id=${record.id}"><fmt:message key="index.record.edit"/></a>
                            <a href="controller?action=deleterecord&id=${record.id}"><fmt:message key="index.record.delete"/></a>
                        </c:if>
                    </div>
...
<div class="row">
    <div class="container">
        <nav aria-label="...">
            <ul class="pager">
                <li class="previous${leftPageClass}"><a href="${leftPage}"><span aria-hidden="true">&larr;</span> <fmt:message key="index.newer"/></a></li>
                <li class="next${rightPageClass}"><a href="${rightPage}"><fmt:message key="index.older"/> <span aria-hidden="true">&rarr;</span></a></li>
            </ul>
        </nav>
    </div>
</div>
