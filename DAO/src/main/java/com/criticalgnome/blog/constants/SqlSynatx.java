...
public class SqlSynatx {
    ...
    public static final String SELECT_FROM_TAG_WHERE_RECORD_HAS_TAG_RECORD_ID = "SELECT * FROM tag, record_has_tag WHERE record_has_tag.record_id = ? AND record_has_tag.tag_id = tag.id;";
    // User table
