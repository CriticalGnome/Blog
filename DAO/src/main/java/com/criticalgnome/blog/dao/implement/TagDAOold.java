 ...
 */
public class TagDAOold extends AbstractDAOold<Tag> {

    private static volatile TagDAOold instance;
    private static final Logger logger = LogManager.getLogger(TagDAOold.class);

    private TagDAOold() {}

    public static TagDAOold getInstance() {
        if (instance == null) {
            synchronized (TagDAOold.class) {
                if (instance == null) {
                    instance = new TagDAOold();
                }
            }
        }
        return instance;
